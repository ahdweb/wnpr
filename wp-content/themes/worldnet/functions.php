...
function twentytwelve_scripts_styles() {
	...
	/*
	 * Adds JavaScript for handling the navigation menu .
	 */
	wp_enqueue_script('jquery');
	wp_enqueue_script( 'navigation', get_template_directory_uri() . '/js/custom.js', array(), '1.0', true );
	 ...
	 */
	wp_enqueue_style( 'webelephants-style', get_stylesheet_uri() );
	wp_enqueue_style( 'menu', get_template_directory_uri() . '/css/menu-style.css');

	//Responsive Tables
	wp_enqueue_style( 'responsive-tables', get_template_directory_uri().'/css/responsive-tables.css' );
	wp_enqueue_script( 'responsive-tables-js', get_template_directory_uri() . '/js/responsive-tables.js', array(), '1.0', true );
...
function twentytwelve_widgets_init() {
	register_sidebar( array(
		...
		'id' => 'sidebar-1',
		'description' => __( 'Appears on right sidebar page template, which has its own widgets', 'twentytwelve' ),
	...
	register_sidebar( array(
		'name' => __( 'Left Sidebar Widget Area', 'twentytwelve' ),
		'id' => 'sidebar-2',
		'description' => __( 'Appears when using the optional Left Sidebar Page Template', 'twentytwelve' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
...
register_sidebar( array(
		'name' => __( 'Posts Right Sidebar', 'twentytwelve' ),
		'id' => 'sidebar-5',
		'description' => __( 'Appears when using the optional Front Page template with a page set as Static Front Page', 'twentytwelve' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
