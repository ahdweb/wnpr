...
$MyUpdateChecker = new PluginUpdateChecker('http://joomla-gtranslate.googlecode.com/svn/trunk/wp_metadata_mini.json', __FILE__, 'gtw');
...
<a href="#" onclick="doGTranslate('en|es');return false;" title="Espa&ntilde;ol" class="gflag nturl" style="background-position:-600px -200px;"><img src="http://50.116.122.133/~worldnet/wp-content/themes/worldnet/images/but-idioma-espanol-on.png" height="26" width="66" alt="Spanish" /></a>
<a href="#" onclick="doGTranslate('en|en');return false;" title="English" class="gflag nturl" style="background-position:-0px -0px;"><img src="http://50.116.122.133/~worldnet/wp-content/themes/worldnet/images/but-idioma-english-off.png" height="26" width="66" alt="English" /></a>
<!--<br />
