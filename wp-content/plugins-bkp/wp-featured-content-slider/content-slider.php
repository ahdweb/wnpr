...
<script type="text/javascript">
	jQuery('#featured_slider div#_slide').cycle({ 
...
<div id="featured_slider">
	<div id="_slide">
		...
		<div class="banner_left content_left"><h2><?php the_title();?></h2><?php echo c_slider_cut_text(get_the_content(), $c_slider_limit, $c_slider_points);?><a href="<?php the_permalink();?>" class="learn_how">Learn How</a></div><div class="banner_right"><img src="<?php echo $c_slider_thumb;?>" /></div></div>
		<?php endforeach; ?>
	</div>
</div>